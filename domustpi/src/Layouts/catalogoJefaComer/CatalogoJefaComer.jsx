...
import {HeaderJefaComer,PropModJefaComer, FooterGeneral} from '../../Components';


function CatalogoJefaComer() {
    ...
    <>
      ...
      <div className="mx-auto col-12 p-5 row gap-4 justify-content-center">
        {propMods.map(propMod=>(
                  ...
                  <PropModJefaComer direccion={propMod.direccion} precio={propMod.precio} descripcion={propMod.descripcion} imagen={propMod.imagen}/>
...
export default CatalogoJefaComer